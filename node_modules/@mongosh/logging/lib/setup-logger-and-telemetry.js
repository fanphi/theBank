...
function setupLoggerAndTelemetry(bus, log, analytics, userTraits, mongosh_version) {
    ...
    bus.on('mongosh:csfle-load-skip', function (ev) {
        log.info('CSFLE', (0, mongodb_log_writer_1.mongoLogId)(1000000050), 'csfle', 'Skipping shared library candidate', ev);
    });
    bus.on('mongosh:csfle-load-found', function (ev) {
        log.warn('CSFLE', (0, mongodb_log_writer_1.mongoLogId)(1000000051), 'csfle', 'Accepted shared library candidate', {
