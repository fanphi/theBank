...
class CliRepl {
    ...
    setupAnalytics() {
        ...
        this.segmentAnalytics = new analytics_node_1.default(apiKey, this.analyticsOptions);
    ...
    async getCSFLELibraryOptions() {
        ...
        if (!this.getCSFLELibraryPaths) {
            throw new errors_1.MongoshInternalError('This instance of mongosh is not configured for CSFLE');
        }
        return ((_a = this.cachedCSFLELibraryPath) !== null && _a !== void 0 ? _a : (this.cachedCSFLELibraryPath = this.getCSFLELibraryPaths(this.bus)));
    }
